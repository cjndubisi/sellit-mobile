...
class _WelcomeScreen extends State<WelcomeScreen> {
  ...
  final PageDecoration myPage =
      const PageDecoration(bodyTextStyle: TextStyle(fontSize: 14));
  ...
  List<PageViewModel> getPages() {
    return [
      PageViewModel(
          ...
          title: 'Sign up now',
          body:
              'Do you have any item to sell / buy? Get started by creating an account',
          decoration: myPage),
      PageViewModel(
          image: Image.asset('assets/images/splash2.png'),
          title: 'Competitive',
          body:
              'Prices are competitive and attractive. You have a wide range of options to choose from',
          decoration: myPage),
      PageViewModel(
          image: Image.asset('assets/images/splash3.png'),
          title: 'Speedy delivery',
          body:
              'Seller accepts your bid and item gets delivered to you seamlessly',
          decoration: myPage),
    ];
  }
